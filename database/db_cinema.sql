-- Excluir o banco de dados, caso j� exista
...
-- Consultar todos os filmes e seus g�neros correspondentes:
...
-- Consultar todos os filmes de um determinado g�nero:
SELECT filmes.titulo, GROUP_CONCAT(generos.nome SEPARATOR ', ') AS generos
FROM filmes
JOIN filmes_generos ON filmes.id = filmes_generos.filme_id
JOIN generos ON filmes_generos.genero_id = generos.id
WHERE generos.nome = 'a��o'
GROUP BY filmes.id

-- Consultar os g�neros mais populares:
